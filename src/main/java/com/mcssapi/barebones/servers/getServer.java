...
public class getServer {
     ...
     * @param: Filter (none, minimal, status) see documentation for more information, can be null
     * @return the server information as a JSON object
     */
    public static JSONObject getServer(String IP, String ApiKey, String ServerId, Boolean SSL, @Nullable String Filter) {
